...
export default function Header({ toggleTheme, darkTheme }) {
  return (
    <div className="flex justify-end py-3 w-full border-b-[1px] dark:border-gray-700">
        <div className="space-x-2 pr-4">
            <Link href="https://github.com/rezakurniawan88/rock-paper-scissors-classification" target="_blank">
                <button className="p-2 hover:bg-slate-100 rounded-lg dark:text-white dark:hover:bg-gray-700">
            ...
            <button className="p-2 hover:bg-slate-100 rounded-lg dark:text-white dark:hover:bg-gray-700" onClick={toggleTheme}>
                {darkTheme ? (
